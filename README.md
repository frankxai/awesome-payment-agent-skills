...
| **x402** | x402 Foundation (Coinbase + Cloudflare); members incl. Google, Visa, AWS, Circle, Anthropic, Vercel | **Settlement rail** — revives HTTP `402 Payment Required`; the agent signs a USDC stablecoin transaction onchain (Base / Solana). Account-less, zero protocol fee. | Apache 2.0 | [x402.org](https://www.x402.org/) · [foundation members](https://x402.org/members/) |
